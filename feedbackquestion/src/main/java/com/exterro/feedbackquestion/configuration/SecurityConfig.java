...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                .authorizeRequests().requestMatchers("/home", "/feed").permitAll()
                .and()
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers("/feedback.html", "/script/feedbackquestion.js", "/submitFeedback", "/giveFeedback","/submitRegistration", "/questions.html","/feedbackForm","/results.html","/viewFeedbackbyEmail");
    }
